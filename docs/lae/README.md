...
> 状态：Draft v0.9；Luma CLI、Control 与 manager agent 包版本为 `0.1.233`，LAE 9 个平台 service 已运行 exact ref `c7873e6caf08344e683da9d9c2992445792bab55`（Nomad job v53）；四服务 Compose 冷启动、双 HTTPS/双卷产品 E2E、四模板 smoke/自动下架恢复与 clean-room CLI/Skill E2E 已通过，完整来源、安全与数据恢复矩阵仍待完成
> 日期：2026-07-14
