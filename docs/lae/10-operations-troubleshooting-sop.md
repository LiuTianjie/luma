...
截至 2026-07-11，Luma `0.1.171` 候选已通过 719/719 gate，当前 live fleet 仍为
`0.1.170`。LAE staging 的 9 个 task、TLS 和上述四项探针健康；真实注册/token/
CLI/template/analysis 已跑，但 tenant Runtime deploy/lifecycle 仍待最终 E2E。
