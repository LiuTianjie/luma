...
```bash
python -m pip install "luma-infra==0.1.266"
```
...
```bash
luma update fleet
luma update fleet --install-ref v0.1.266 --timeout 900
...
the required target platform or local registry/mirror configuration.
